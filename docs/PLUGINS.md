...
| `community`    | On                            | —                                | Poll/giveaway/suggestion/announcement/reminder/event defaults, auto-publish, auto-threads                           | `/dashboard/[guildId]/community`       | [`packages/plugins/src/community/README.md`](../packages/plugins/src/community/README.md)       |
