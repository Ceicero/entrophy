...
export const NAV: NavItem[] = [
  ...
  { href: (id) => `/dashboard/${id}/engagement`, label: 'Engagement', icon: TrendingUp, pluginId: 'engagement' },
  { href: (id) => `/dashboard/${id}/community`, label: 'Community', icon: PartyPopper, pluginId: 'community' },
  { href: (id) => `/dashboard/${id}/integrations`, label: 'Integrations', icon: Plug, pluginId: 'integrations' },
