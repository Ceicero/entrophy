...
export const pluginCopy: Record<PluginId, PluginCopy> = {
  ...
  media: {
    ...
    highlights: ['Optional / provider required', 'No scraping, ever', 'Queue & DJ role', 'Clear status messaging'],
  },
  integrations: {
  ...
  ai: {
    ...
    highlights: ['Disabled by default', 'Suggests, never acts', 'Per-channel allowlist', 'Provider key required'],
  },
};
